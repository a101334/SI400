...
public class Secretaria extends Pessoa{
    ...
    public Secretaria(String nome, Date nascimentoPessoa, String cep, String estado, String cidade, String bairro, String rua, int numCasa, String email, int tipo, String login, String senha) {
